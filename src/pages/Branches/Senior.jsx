    ...
    <>
      <div className="branchDetailsContainer">
        <div className={styles.contentContainer}>
          ...
          <p className={styles.subText}><strong> -&gt; </strong> A tropa pode ser masculina (Tropa Sênior), feminina (Tropa Guia) ou mista, e é organizada em até quatro patrulhas, cada uma composta por 4 a 6 jovens. Cada patrulha escolhe um nome representativo, inspirado em acclassNameentes geográficos conhecclassNameos ou em tribos indígenas brasileiras.</p>
          <p className={styles.subText}><strong> -&gt; </strong>Na Tropa Sênior/Guia, a relação entre a chefia e os membros se diferencia dos ramos Lobinho e Escoteiro. Aqui, os jovens possuem maturclassNameade suficiente para traçar seus próprios caminhos, recebendo apenas o suporte necessário dos chefes. Esse ramo é conhecclassNameo por exigir maior esforço físico e mais conhecimento, proporcionando aos participantes uma evolução significativa.</p>
